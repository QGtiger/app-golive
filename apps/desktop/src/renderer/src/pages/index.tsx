...
import { ChevronRight, ClipboardList, Folder, FolderOpen, HardDrive, Settings as SettingsIcon } from 'lucide-react'
    ...
    <>
      <header className="header">
        ...
        <div style={{ display: 'flex', gap: 2 }}>
          <button className="icon-btn" title="打开日志目录" onClick={() => { void api.openLogDir() }}>
